...
//           <div className="w-20 h-20 rounded-full bg-blue-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg shadow-blue-200 flex-shrink-0">
//             {initials}
//           </div>
...
//               <Mail size={14} />
//               <span className="truncate">{user?.email || "tourist@example.com"}</span>
//             </div>
//           </div>
//         </div>
//       </Card>
...
//           <Button onClick={handleProfileSave} size="md">
...
//         <div className="mt-6 flex items-center gap-3">
//           <Button onClick={handlePasswordSave} size="md">
